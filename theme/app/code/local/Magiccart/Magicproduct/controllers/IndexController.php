 ...
 * @@Modify Date: 2016-02-01 14:09:35
 * @@Function:
 */
?>
<?php
class Magiccart_Magicproduct_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function productAction()
    {
        ...
        $breadcrumbs->addCrumb("magicproduct", array(
                "label" => $this->__($title),
                "title" => $this->__($title)
           )); 
        $this->renderLayout();
