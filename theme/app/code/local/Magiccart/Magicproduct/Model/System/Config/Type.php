 ...
 * @@Modify Date: 2014-11-03 11:41:46
 * @@Function:
 */
?>
<?php
class Magiccart_Magicproduct_Model_System_Config_Type
{
    ...
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => self::FEATURED,    'label'=>Mage::helper('adminhtml')->__('Featured')),
            array('value' => self::LATEST,   	'label'=>Mage::helper('adminhtml')->__('Latest')),
