 ...
 * @@Modify Date: 2016-01-05 16:54:37
 * @@Function:
 */
?>
<?php
class Magiccart_Magiccategory_Block_Adminhtml_Manage_Edit_Tab_Config extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('config_form', array('legend'=>Mage::helper('magiccategory')->__('General Information')));
		...
		$row = $fieldset->addField('row', 'select', array(
			...
			'name'      => 'row',
			'values'	=> Mage::getSingleton('magiccategory/system_config_row')->toOptionArray(),
			'value'     => array(1),
		));
        ...
        $fieldset->addField('action', 'multiselect', array(
            ...
            'values'	=> Mage::getSingleton('magiccategory/system_config_action')->toOptionArray(),
